...
# run the model
#-------------------------------------
#' fitRec will run the futR.cpp recruitment model
...
#' 
#' 
fitRec<-function(dlistIN=dlist,version="futR",silentIN=TRUE,
                 se.fit=TRUE,simulate=FALSE,simnitr=1000,
                 recompile=FALSE,maxitr=10000,maxeval=10000){
