...
\section{Recruitment formulations
...
\subsection{rectype = 1. Log-linear}\label{rectype-1.-log-linear}}
...
\subsection{rectype = 2. Log-linear with
...
\subsection{rectype = 3. Beverton Holt}\label{rectype-3.-beverton-holt}}
...
\subsection{rectype = 4. Ricker}\label{rectype-4.-ricker}}
...
\section{Observation error options
...
\subsection{sigMethod = 1}\label{sigmethod-1}}
...
\subsection{sigMethod = 2}\label{sigmethod-2}}
...
\subsection{sigMethod = 3}\label{sigmethod-3}}
...
\subsection{sigMethod = 4}\label{sigmethod-4}}
...
\subsection{sigMethod = 5}\label{sigmethod-5}}
...
\subsection{Step 1: Installing futR()}\label{step-1-installing-futr}}
...
\hypertarget{explore-different-rs-relationship-fits}{%
\section{Explore different R/S relationship
fits}\label{explore-different-rs-relationship-fits}}

\hypertarget{rectype-1}{%
\subsection{rectype = 1}\label{rectype-1}}
...
\subsection{rectype = 2}\label{rectype-2}}
...
\subsection{rectype = 3}\label{rectype-3}}
...
\subsection{rectype = 4}\label{rectype-4}}
...
\includegraphics{futR_demo_files/figure-latex/plotR4_covpar-1.pdf}

\hypertarget{explore-observation-error-options-sigmethod}{%
\section{Explore observation error options
(sigMethod)}\label{explore-observation-error-options-sigmethod}}
...
\hypertarget{run-this-code-first}{%
\subsubsection{Run this code first}\label{run-this-code-first}}
...
\hypertarget{now-explore-different-sigmethod-settings-starting-with-sigmethod-0.-note-comparitive-plots-at-the-bottom-of-each-tab.}{%
\subsubsection{Now explore different sigMethod settings starting with
sigMethod = 0. Note comparitive plots at the bottom of each
tab.}\label{now-explore-different-sigmethod-settings-starting-with-sigmethod-0.-note-comparitive-plots-at-the-bottom-of-each-tab.}}

\hypertarget{sigmethod-1-1}{%
\subsection{sigMethod = 1}\label{sigmethod-1-1}}
...
\subsection{sigMethod = 2}\label{sigmethod-2-1}}
...
\subsection{sigMethod = 3}\label{sigmethod-3-1}}
...
\subsection{sigMethod = 4}\label{sigmethod-4-1}}
...
\subsection{sigMethod = 5}\label{sigmethod-5-1}}
