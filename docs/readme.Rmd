...
# source("R/make.R")
 # copy and paste this into R window (won't work within markdown)
  tmpwd<- getwd()
  setwd(file.path(tmpwd,"docs"))
  rmd2md(rmd_fl = "futR_demo",md_fl = "README")
  setwd(tmpwd)
    file.copy(from = file.path(tmpwd,"docs","README.md"),
            to = file.path(tmpwd,"README.md"),overwrite = T)
  file.copy(from = file.path(tmpwd,"docs","futR_demo.md"),
            to = file.path(tmpwd,"vignettes","futR_demo.md"),overwrite = T)
  file.copy(from = file.path(tmpwd,"docs","futR_demo.Rmd"),
            to = file.path(tmpwd,"vignettes","futR_demo.Rmd"),overwrite = T)
    file.copy(from = file.path(tmpwd,"docs","futR_demo.html"),
