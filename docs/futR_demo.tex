...
github repo: \url{https://github.com/kholsman/futR}

\includegraphics[width=0.25\textwidth,height=\textheight]{../Figs/futR_icon.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{devtools}\SpecialCharTok{::}\FunctionTok{install\_github}\NormalTok{(}\StringTok{"kholsman/futR"}\NormalTok{,}\AttributeTok{force=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
  \CommentTok{\# rm(list=ls()); setwd("/Volumes/LaCie/GitHub\_cloud/futR")}
  ...
  \CommentTok{\# rm(list=ls()) ; dir()}
   \FunctionTok{library}\NormalTok{(futR)}

  \CommentTok{\# load data, packages, setup, etc.}
  \FunctionTok{source}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(}\StringTok{"R"}\NormalTok{,}\StringTok{"01\_make.R"}\NormalTok{))}
...
\NormalTok{    wd0 }\OtherTok{\textless{}{-}} \FunctionTok{getwd}\NormalTok{()}
    \FunctionTok{setwd}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(}\StringTok{"src"}\NormalTok{,}\StringTok{"TMB"}\NormalTok{))}
\NormalTok{      futR}\SpecialCharTok{::}\FunctionTok{recompile}\NormalTok{(}\StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{)}
...
\emph{Note: If you get a compilation error try re-installing RTools
...
\NormalTok{  datlist }\OtherTok{\textless{}{-}}\NormalTok{ futR}\SpecialCharTok{::}\FunctionTok{makefutR\_data}\NormalTok{(}\AttributeTok{fn =} \FunctionTok{file.path}\NormalTok{(}\StringTok{"data{-}raw"}\NormalTok{,}\StringTok{"in"}\NormalTok{,}\StringTok{"futR\_Inputs.xlsx"}\NormalTok{ ), }\AttributeTok{export\_all=}\NormalTok{F)}
...
\NormalTok{  datlist}\SpecialCharTok{$}\NormalTok{maplist}
  ...
  \CommentTok{\# which phases to estimate in  }
...
\NormalTok{  updatePlots }\OtherTok{\textless{}{-}} \DecValTok{1}
  \CommentTok{\# \# hand code datlist:}
\NormalTok{  datlist  }\OtherTok{\textless{}{-}}\NormalTok{  futR}\SpecialCharTok{::}\FunctionTok{makeDat}\NormalTok{(}
...
\NormalTok{  Rec1 }\OtherTok{\textless{}{-}}\NormalTok{  mm }\OtherTok{\textless{}{-}}\NormalTok{futR}\SpecialCharTok{::}\FunctionTok{runRecMod}\NormalTok{(}\AttributeTok{dlistIN   =}\NormalTok{ datlist,}
                          \AttributeTok{version   =} \StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{,}
                          \AttributeTok{src\_fldr   =} \FunctionTok{file.path}\NormalTok{(}\StringTok{"src"}\NormalTok{,}\StringTok{"TMB"}\NormalTok{),}
...
\NormalTok{  r1\_fit  }\OtherTok{\textless{}{-}}\NormalTok{ futR}\SpecialCharTok{::}\FunctionTok{getFit}\NormalTok{(mm, }\AttributeTok{nm =} \StringTok{"recType = 1"}\NormalTok{)}
\NormalTok{  rec\_fit }\OtherTok{\textless{}{-}}\NormalTok{ r1\_fit}
  \FunctionTok{rm}\NormalTok{(mm)}
  
\NormalTok{  W }\OtherTok{\textless{}{-}} \DecValTok{6}\NormalTok{; H1 }\OtherTok{=} \DecValTok{4}
  \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
   \FunctionTok{print}\NormalTok{(rec\_fit)}
   \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/recplot1.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H1, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
   \FunctionTok{print}\NormalTok{( futR}\SpecialCharTok{::}\FunctionTok{plot\_rs}\NormalTok{(r1\_fit))}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=\textheight]{../Figs/recplot1.jpg}
\caption{mean recruitment}
\end{figure}
...
\NormalTok{  datlist  }\OtherTok{\textless{}{-}}  \FunctionTok{makeDat}\NormalTok{(}
  ...
  \CommentTok{\# run the basic model}
\NormalTok{  Rec2 }\OtherTok{\textless{}{-}}\NormalTok{  mm }\OtherTok{\textless{}{-}}\NormalTok{futR}\SpecialCharTok{::}\FunctionTok{runRecMod}\NormalTok{(}\AttributeTok{dlistIN   =}\NormalTok{ datlist,}
                          \AttributeTok{version   =} \StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{,}
                          \AttributeTok{src\_fldr   =} \StringTok{"src/TMB"}\NormalTok{,}
                          \AttributeTok{recompile =} \ConstantTok{FALSE}\NormalTok{,}
                          \AttributeTok{simulate  =} \ConstantTok{TRUE}\NormalTok{,}
                          \AttributeTok{sim\_nitr  =} \DecValTok{1000}\NormalTok{)}
  \CommentTok{\# summarize results}
...
\NormalTok{  rec\_fit }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(rec\_fit,r2\_fit)}
 \FunctionTok{rm}\NormalTok{(mm)}
 \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
   \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/recplot2.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H1, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{../Figs/recplot2.jpg}\\
\#\#\# rectype = 3
...
\NormalTok{  rec\_fit }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(rec\_fit,r3\_fit)}
  ...
  \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
     \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/recplot3.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H1, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
     \FunctionTok{print}\NormalTok{(}\FunctionTok{plot\_rs}\NormalTok{(rec\_fit))}
     \FunctionTok{dev.off}\NormalTok{()}
\NormalTok{  \}}
\end{Highlighting}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{../Figs/recplot3.jpg}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{  estparams\_0 }\OtherTok{\textless{}{-}}\NormalTok{ estparams}
\NormalTok{  estparams\_0[[}\StringTok{"beta"}\NormalTok{]] }\OtherTok{\textless{}{-}}\NormalTok{ estparams\_0[[}\StringTok{"lambda"}\NormalTok{]] }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
  \CommentTok{\# makeDat will make the input values, data, and phases for the model:}
\NormalTok{  datlist  }\OtherTok{\textless{}{-}}  \FunctionTok{makeDat}\NormalTok{(}
                    \AttributeTok{rectype    =}  \DecValTok{4}\NormalTok{,}
                    \AttributeTok{tauIN      =}  \DecValTok{0}\NormalTok{,}
                    \AttributeTok{sigMethod  =}  \DecValTok{1}\NormalTok{, }\CommentTok{\# (default, no random effects)}
                    \AttributeTok{estparams  =}\NormalTok{  estparams\_0,}
                    \AttributeTok{estMode    =}  \DecValTok{1}\NormalTok{,}
                    \AttributeTok{rec\_years  =}\NormalTok{  rec}\SpecialCharTok{$}\NormalTok{rec\_year,}
                    \AttributeTok{Rec        =}\NormalTok{  rec}\SpecialCharTok{$}\NormalTok{Robs,}
                    \AttributeTok{SSB        =}\NormalTok{  rec}\SpecialCharTok{$}\NormalTok{SSB,}
...
\NormalTok{  dfR4    }\OtherTok{\textless{}{-}}  \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{model =} \StringTok{"Rec 4"}\NormalTok{,}
                     \AttributeTok{estimate  =} \FunctionTok{as.vector}\NormalTok{(mm}\SpecialCharTok{$}\NormalTok{sim),}
                     \AttributeTok{parameter =} \FunctionTok{names}\NormalTok{( mm}\SpecialCharTok{$}\NormalTok{mle)[}\FunctionTok{row}\NormalTok{(mm}\SpecialCharTok{$}\NormalTok{sim)])}
\NormalTok{  df      }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(dfR4)}
...
\NormalTok{  rec\_fit }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(rec\_fit,r4\_fit)}
 \FunctionTok{rm}\NormalTok{(mm)}
 \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
   \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/recplot4.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H1, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
   \FunctionTok{print}\NormalTok{(}\FunctionTok{plot\_rs}\NormalTok{(rec\_fit))}
   \FunctionTok{dev.off}\NormalTok{()}
\NormalTok{ \}}
\end{Highlighting}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{../Figs/recplot4.jpg}
...
\begin{Highlighting}[]
  ...
  \CommentTok{\#datlist \textless{}{-} makefutR\_data("data/in/futR\_Inputs.xlsx" )}
\NormalTok{  datlist }\OtherTok{\textless{}{-}} \FunctionTok{makefutR\_data}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(}\StringTok{"data{-}raw"}\NormalTok{,}\StringTok{"in"}\NormalTok{,}\StringTok{"futR\_Inputs.xlsx"}\NormalTok{ ))}

\NormalTok{  datlist\_post }\OtherTok{\textless{}{-}}\NormalTok{ datlist}
\NormalTok{  datlist\_pre  }\OtherTok{\textless{}{-}}\NormalTok{ datlist}
\NormalTok{  datlist\_post}\SpecialCharTok{$}\NormalTok{estparams[[}\StringTok{"beta"}\NormalTok{]] }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
\NormalTok{  datlist\_pre}\SpecialCharTok{$}\NormalTok{estparams[[}\StringTok{"lambda"}\NormalTok{]] }\OtherTok{\textless{}{-}} \ConstantTok{FALSE}
  \CommentTok{\# run the basic model}
...
\NormalTok{  r4\_fit\_c  }\OtherTok{\textless{}{-}} \FunctionTok{getFit}\NormalTok{(mm, }\AttributeTok{nm =} \StringTok{"recType = 4 with pre{-} and post{-} covar"}\NormalTok{)}
\NormalTok{  rec\_fit   }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(r4\_fit,r4\_fit\_c)}
  \FunctionTok{rm}\NormalTok{(mm)}
  
  
  \CommentTok{\# run the basic model}
\NormalTok{   mm }\OtherTok{\textless{}{-}}\FunctionTok{runRecMod}\NormalTok{(}\AttributeTok{dlistIN   =}\NormalTok{ datlist\_pre,}
                          \AttributeTok{version   =} \StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{,                           }
                          \AttributeTok{src\_fldr   =} \StringTok{"src/TMB"}\NormalTok{,}
                          \AttributeTok{recompile =} \ConstantTok{FALSE}\NormalTok{,}
                          \AttributeTok{simulate  =} \ConstantTok{TRUE}\NormalTok{,}
  ...
  \CommentTok{\# summarize results}
\NormalTok{  dfR4\_c\_pre    }\OtherTok{\textless{}{-}}  \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{model =} \StringTok{"Rec 4 with covar on pre"}\NormalTok{,}
                     \AttributeTok{estimate  =} \FunctionTok{as.vector}\NormalTok{(mm}\SpecialCharTok{$}\NormalTok{sim),}
                     \AttributeTok{parameter =} \FunctionTok{names}\NormalTok{( mm}\SpecialCharTok{$}\NormalTok{mle)[}\FunctionTok{row}\NormalTok{(mm}\SpecialCharTok{$}\NormalTok{sim)])}
\NormalTok{  df      }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(df,dfR4\_c\_pre)}
\NormalTok{  r4\_fit\_c\_pre  }\OtherTok{\textless{}{-}} \FunctionTok{getFit}\NormalTok{(mm, }\AttributeTok{nm =} \StringTok{"recType = 4 with pre{-}covar"}\NormalTok{)}
\NormalTok{  rec\_fit }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(rec\_fit,r4\_fit\_c\_pre)}
  
  \FunctionTok{rm}\NormalTok{(mm)}
  \CommentTok{\# run the basic model}
\NormalTok{   mm }\OtherTok{\textless{}{-}}\FunctionTok{runRecMod}\NormalTok{(}\AttributeTok{dlistIN   =}\NormalTok{ datlist\_post,}
                          \AttributeTok{version   =} \StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{,                           }
                          \AttributeTok{src\_fldr   =} \StringTok{"src/TMB"}\NormalTok{,}
                          \AttributeTok{recompile =} \ConstantTok{FALSE}\NormalTok{,}
                          \AttributeTok{simulate  =} \ConstantTok{TRUE}\NormalTok{,}
  ...
  \CommentTok{\# summarize results}
\NormalTok{  dfR4\_c\_post    }\OtherTok{\textless{}{-}}  \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{model =} \StringTok{"Rec 4 with covar on post"}\NormalTok{,}
                     \AttributeTok{estimate  =} \FunctionTok{as.vector}\NormalTok{(mm}\SpecialCharTok{$}\NormalTok{sim),}
                     \AttributeTok{parameter =} \FunctionTok{names}\NormalTok{( mm}\SpecialCharTok{$}\NormalTok{mle)[}\FunctionTok{row}\NormalTok{(mm}\SpecialCharTok{$}\NormalTok{sim)])}
\NormalTok{  df      }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(df,dfR4\_c\_post)}
\NormalTok{  r4\_fit\_c\_post  }\OtherTok{\textless{}{-}} \FunctionTok{getFit}\NormalTok{(mm, }\AttributeTok{nm =} \StringTok{"recType = 4 with post{-}covar"}\NormalTok{)}
\NormalTok{  rec\_fit }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(rec\_fit,r4\_fit\_c\_post)}
  
  \FunctionTok{rm}\NormalTok{(mm)}
  
  
 \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
   \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/recplot5.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H1, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
   \FunctionTok{print}\NormalTok{(}\FunctionTok{plot\_rs}\NormalTok{(rec\_fit))}
   \FunctionTok{dev.off}\NormalTok{()}
\NormalTok{ \}}
\end{Highlighting}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{../Figs/recplot5.jpg}
...
\NormalTok{  H2 }\OtherTok{\textless{}{-}} \DecValTok{5}
 \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
    \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/plotpar1.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H2, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{../Figs/plotpar1.jpg}
...
\NormalTok{  peak }\OtherTok{\textless{}{-}}\NormalTok{ df}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{group\_by}\NormalTok{(model,parameter)}\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{names}\NormalTok{(peak)}\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"model"}\NormalTok{,}\StringTok{"parameter"}\NormalTok{,}\StringTok{"freq"}\NormalTok{,}\StringTok{"n"}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
     \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/plotpar2.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H2, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{../Figs/plotpar2.jpg}
...
\NormalTok{  peak }\OtherTok{\textless{}{-}}\NormalTok{ df}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{group\_by}\NormalTok{(model,parameter)}\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{names}\NormalTok{(peak)}\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"model"}\NormalTok{,}\StringTok{"parameter"}\NormalTok{,}\StringTok{"freq"}\NormalTok{,}\StringTok{"n"}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
    \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/plotpar3.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H2, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
    \FunctionTok{print}\NormalTok{(}\FunctionTok{plot\_par\_pdf}\NormalTok{(df))}
    \FunctionTok{dev.off}\NormalTok{()}
\NormalTok{  \}}
\end{Highlighting}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{../Figs/plotpar3.jpg}
...
\NormalTok{   datlist  }\OtherTok{\textless{}{-}}  \FunctionTok{makeDat}\NormalTok{(}
  ...
  \CommentTok{\# re{-}run the model with tau}
\NormalTok{  m\_S4 }\OtherTok{\textless{}{-}}\NormalTok{  mm }\OtherTok{\textless{}{-}} \FunctionTok{runRecMod}\NormalTok{(}\AttributeTok{dlistIN=}\NormalTok{datlist,}
                           \AttributeTok{version=}\StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{,}
                           \AttributeTok{src\_fldr   =} \StringTok{"src/TMB"}\NormalTok{,}
                           \AttributeTok{recompile=}\NormalTok{F,}
                           \AttributeTok{simulate=}\ConstantTok{TRUE}\NormalTok{,}
...
\NormalTok{  peak }\OtherTok{\textless{}{-}}\NormalTok{ df}\SpecialCharTok{\%\textgreater{}\%}\FunctionTok{group\_by}\NormalTok{(model,parameter)}\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{names}\NormalTok{(peak)}\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"model"}\NormalTok{,}\StringTok{"parameter"}\NormalTok{,}\StringTok{"freq"}\NormalTok{,}\StringTok{"n"}\NormalTok{)}
  \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
    \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/plotpar4.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H2, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
    \FunctionTok{print}\NormalTok{(}\FunctionTok{plot\_par\_pdf}\NormalTok{(df))}
    \FunctionTok{dev.off}\NormalTok{()}
\NormalTok{  \}}
\end{Highlighting}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{../Figs/plotpar4.jpg}
...
\NormalTok{  m\_S5 }\OtherTok{\textless{}{-}}\NormalTok{  mm }\OtherTok{\textless{}{-}} \FunctionTok{runRecMod}\NormalTok{(}\AttributeTok{dlistIN=}\NormalTok{datlist,}
                           \AttributeTok{version=}\StringTok{\textquotesingle{}futR\textquotesingle{}}\NormalTok{,}
                           \AttributeTok{src\_fldr   =} \StringTok{"src/TMB"}\NormalTok{,}
                           \AttributeTok{recompile=}\NormalTok{F,}
                           \AttributeTok{simulate=}\ConstantTok{TRUE}\NormalTok{,}
...
\NormalTok{  df }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(df, df\_S5)}
  \ControlFlowTok{if}\NormalTok{(updatePlots)\{}
    \FunctionTok{jpeg}\NormalTok{(}\StringTok{"Figs/plotpar5.jpg"}\NormalTok{, }\AttributeTok{width =}\NormalTok{ W, }\AttributeTok{height=}\NormalTok{ H2, }\AttributeTok{res =} \DecValTok{250}\NormalTok{, }\AttributeTok{units =} \StringTok{"in"}\NormalTok{)}
    \FunctionTok{print}\NormalTok{(}\FunctionTok{plot\_par\_pdf}\NormalTok{(df))}
    \FunctionTok{dev.off}\NormalTok{()}
\NormalTok{  \}}
\end{Highlighting}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{../Figs/plotpar5.jpg}
